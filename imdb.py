...
class ImdbSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for cell in  table:
            ...
            direcror_cast = cell.xpath('./div[@class="lister-item-content"]/p[@class=""]/child::*')
            ds = []
            ...
            yield{
                ...
                'director': director,
                'star': star,
                'votes': cell.css('p[class="sort-num_votes-visible"] span[name="nv"]::text').extract_first().strip(','),
